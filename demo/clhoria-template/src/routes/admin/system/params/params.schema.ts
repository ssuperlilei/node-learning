...
import {
  insertSystemParamsSchema,
  selectSystemParamsSchema,
} from "@/db/schema";
...
const paramBaseFields = {
  ...
  valueType: z
    ...
    .optional()
    .meta({ description: "参数值类型" }),
  name: z
    .string()
    .min(1, "参数名称不能为空")
    .max(128, "参数名称最多128个字符")
    .meta({ description: "参数名称" }),
...
export const systemParamCreateSchema =
  insertSystemParamsSchema.extend(paramBaseFields);
...
export const systemParamGetByKeyParamsSchema = z.object({ key: paramKeyField });
